...
#define FFMPEG_CONFIGURATION "--enable-static --disable-shared --enable-pic --enable-optimizations --enable-pthreads --disable-debug --disable-doc --disable-programs --disable-symver --disable-avdevice --disable-postproc --disable-avfilter --disable-swscale-alpha --disable-encoders --disable-muxers --disable-devices --disable-parser=dca --disable-filters --disable-demuxer=srt --disable-demuxer=microdvd --disable-demuxer=jacosub --disable-demuxer=sami --disable-demuxer=realtext --disable-demuxer=dts --disable-demuxer=subviewer --disable-demuxer=subviewer1 --disable-demuxer=pjs --disable-demuxer=vplayer --disable-demuxer=mpl2 --disable-demuxer=webvtt --disable-decoder=text --disable-decoder=srt --disable-decoder=subrip --disable-decoder=microdvd --disable-decoder=jacosub --disable-decoder=sami --disable-decoder=realtext --disable-decoder=dca --disable-decoder=movtext --disable-decoder=subviewer --disable-decoder=subviewer1 --disable-decoder=pjs --disable-decoder=vplayer --disable-decoder=mpl2 --disable-decoder=webvtt --enable-openssl --enable-zlib --enable-libopus --enable-libspeex --enable-libzvbi --arch=x86 --cpu=i686 --cross-prefix=/usr/src/android-ndk-r9d/toolchains/x86-4.8/prebuilt/linux-x86_64/bin/i686-linux-android- --enable-cross-compile --sysroot=/usr/src/android-ndk-r9d/platforms/android-9/arch-x86 --target-os=linux --extra-cflags='-I../modified_src/iconv -I../zvbi-0.2.35/src -I../openssl-1.0.1g/include -I../opus-1.1/include -I../speex-1.2rc1/include -DNDEBUG -DMXTECHS -mandroid -ftree-vectorize -ffunction-sections -funwind-tables -fomit-frame-pointer -funswitch-loops -finline-limit=300 -finline-functions -fpredictive-commoning -fgcse-after-reload -fipa-cp-clone -O3 -mtune=atom -msse3 -mfpmath=sse -fstrict-aliasing -no-canonical-prefixes' --extra-libs='-L../libs/x86-atom -L../libs/android/16-x86 -lmxutil -lm' --extra-ldflags= --optflags='-O2 -fno-pic'"
