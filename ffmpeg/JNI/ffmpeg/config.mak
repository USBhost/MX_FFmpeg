...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--enable-static --disable-shared --enable-pic --enable-optimizations --enable-pthreads --disable-debug --disable-doc --disable-programs --disable-symver --disable-avdevice --disable-postproc --enable-avfilter --disable-swscale-alpha --disable-encoders --disable-muxers --disable-devices --disable-filters --enable-filter=yadif --enable-filter=w3fdif --disable-protocol=bluray --disable-protocol=crypto --disable-protocol=data --disable-protocol=gopher --disable-protocol=md5 --disable-protocol=pipe --disable-protocol=udplite --disable-protocol=unix --disable-demuxer=srt --disable-demuxer=microdvd --disable-demuxer=jacosub --disable-demuxer=sami --disable-demuxer=realtext --disable-demuxer=stl --disable-demuxer=subviewer --disable-demuxer=subviewer1 --disable-demuxer=pjs --disable-demuxer=vplayer --disable-demuxer=mpl2 --disable-demuxer=webvtt --disable-decoder=text --disable-decoder=srt --disable-decoder=subrip --disable-decoder=microdvd --disable-decoder=jacosub --disable-decoder=sami --disable-decoder=realtext --disable-decoder=stl --disable-decoder=subviewer --disable-decoder=subviewer1 --disable-decoder=pjs --disable-decoder=vplayer --disable-decoder=mpl2 --disable-decoder=webvtt --enable-openssl --enable-zlib --enable-libopus --enable-libspeex --enable-libzvbi --enable-libmodplug --arch=arm --cpu=armv7-a --cross-prefix=/usr/src/android-ndk-r12b/toolchains/arm-linux-androideabi-4.9/prebuilt/linux-x86_64/bin/arm-linux-androideabi- --cc= --cxx= --ld= --nm= --ar= --as= --enable-cross-compile --sysroot=/usr/src/android-ndk-r12b/platforms/android-19/arch-arm --target-os=linux --extra-cflags='-I../modified_src/iconv -I../zvbi-0.2.35/src -I../openssl-1.0.1g/include -I../opus-1.1/include -I../speex-1.2rc1/include -I../libmodplug/src -DNDEBUG -DMXTECHS -DFF_API_AVPICTURE=0 -ftree-vectorize -ffunction-sections -funwind-tables -fomit-frame-pointer -mfloat-abi=softfp -mfpu=vfpv3-d16 -fstack-protector -fstrict-aliasing -mandroid -fpredictive-commoning -fipa-cp-clone -funswitch-loops -finline-limit=300 -finline-functions -fgcse-after-reload -no-canonical-prefixes -pipe' --extra-libs='-L../libs/armeabi-v7a/vfpv3-d16 -L../libs/android/16-arm -lmxutil -lm' --extra-ldflags='-Wl,--fix-cortex-a8 -march=armv7-a' --optflags=-O2 --disable-neon --disable-decoder=dca --disable-demuxer=dts --disable-bsf=dca_core --disable-demuxer=ac3 --disable-demuxer=eac3 --disable-demuxer=mlp --disable-parser=mlp --disable-decoder=ac3 --disable-decoder=ac3_fixed --disable-decoder=eac3 --disable-decoder=mlp
prefix=/usr/local
...
ARCH=arm
INTRINSICS=none
CC=/usr/src/android-ndk-r12b/toolchains/arm-linux-androideabi-4.9/prebuilt/linux-x86_64/bin/arm-linux-androideabi-gcc
CXX=/usr/src/android-ndk-r12b/toolchains/arm-linux-androideabi-4.9/prebuilt/linux-x86_64/bin/arm-linux-androideabi-g++
AS=/usr/src/android-ndk-r12b/toolchains/arm-linux-androideabi-4.9/prebuilt/linux-x86_64/bin/arm-linux-androideabi-gcc
LD=/usr/src/android-ndk-r12b/toolchains/arm-linux-androideabi-4.9/prebuilt/linux-x86_64/bin/arm-linux-androideabi-gcc
DEPCC=/usr/src/android-ndk-r12b/toolchains/arm-linux-androideabi-4.9/prebuilt/linux-x86_64/bin/arm-linux-androideabi-gcc
DEPCCFLAGS= $(CPPFLAGS)
DEPAS=/usr/src/android-ndk-r12b/toolchains/arm-linux-androideabi-4.9/prebuilt/linux-x86_64/bin/arm-linux-androideabi-gcc
DEPASFLAGS= $(CPPFLAGS)
YASM=yasm
DEPYASM=yasm
AR=/usr/src/android-ndk-r12b/toolchains/arm-linux-androideabi-4.9/prebuilt/linux-x86_64/bin/arm-linux-androideabi-ar
ARFLAGS=rcD
AR_O=$@
RANLIB=/usr/src/android-ndk-r12b/toolchains/arm-linux-androideabi-4.9/prebuilt/linux-x86_64/bin/arm-linux-androideabi-ranlib -D
STRIP=/usr/src/android-ndk-r12b/toolchains/arm-linux-androideabi-4.9/prebuilt/linux-x86_64/bin/arm-linux-androideabi-strip
CP=cp -p
LN_S=ln -s -f
CPPFLAGS= --sysroot=/usr/src/android-ndk-r12b/platforms/android-19/arch-arm -isysroot /usr/src/android-ndk-r12b/platforms/android-19/arch-arm -D_ISOC99_SOURCE -D_FILE_OFFSET_BITS=64 -D_LARGEFILE_SOURCE -Dstrtod=avpriv_strtod -DPIC -DZLIB_CONST
CFLAGS=  -I../modified_src/iconv -I../zvbi-0.2.35/src -I../openssl-1.0.1g/include -I../opus-1.1/include -I../speex-1.2rc1/include -I../libmodplug/src -DNDEBUG -DMXTECHS -DFF_API_AVPICTURE=0 -ftree-vectorize -ffunction-sections -funwind-tables -fomit-frame-pointer -mfloat-abi=softfp -mfpu=vfpv3-d16 -fstack-protector -fstrict-aliasing -mandroid -fpredictive-commoning -fipa-cp-clone -funswitch-loops -finline-limit=300 -finline-functions -fgcse-after-reload -no-canonical-prefixes -pipe -march=armv7-a -std=c99 -fomit-frame-pointer -fPIC -marm -pthread -Wdeclaration-after-statement -Wall -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wwrite-strings -Wtype-limits -Wundef -Wmissing-prototypes -Wno-pointer-to-int-cast -Wstrict-prototypes -Wempty-body -Wno-parentheses -Wno-switch -Wno-format-zero-length -Wno-pointer-sign -O2 -fno-math-errno -fno-signed-zeros -fno-tree-vectorize -Werror=format-security -Werror=implicit-function-declaration -Werror=missing-prototypes -Werror=return-type -Werror=vla -Wformat -fdiagnostics-color=auto -Wno-maybe-uninitialized
CXXFLAGS=  -D__STDC_CONSTANT_MACROS
ASFLAGS=  -I../modified_src/iconv -I../zvbi-0.2.35/src -I../openssl-1.0.1g/include -I../opus-1.1/include -I../speex-1.2rc1/include -I../libmodplug/src -DNDEBUG -DMXTECHS -DFF_API_AVPICTURE=0 -ftree-vectorize -ffunction-sections -funwind-tables -fomit-frame-pointer -mfloat-abi=softfp -mfpu=vfpv3-d16 -fstack-protector -fstrict-aliasing -mandroid -fpredictive-commoning -fipa-cp-clone -funswitch-loops -finline-limit=300 -finline-functions -fgcse-after-reload -no-canonical-prefixes -pipe -march=armv7-a -fPIC
AS_C=-c
AS_O=-o $@
CC_C=-c
CC_E=-E -o $@
...
LD_PATH=-L
DLLTOOL=
WINDRES=/usr/src/android-ndk-r12b/toolchains/arm-linux-androideabi-4.9/prebuilt/linux-x86_64/bin/arm-linux-androideabi-windres
DEPWINDRES=/usr/src/android-ndk-r12b/toolchains/arm-linux-androideabi-4.9/prebuilt/linux-x86_64/bin/arm-linux-androideabi-gcc
DOXYGEN=doxygen
LDFLAGS= -Wl,--fix-cortex-a8 -march=armv7-a  --sysroot=/usr/src/android-ndk-r12b/platforms/android-19/arch-arm -isysroot /usr/src/android-ndk-r12b/platforms/android-19/arch-arm -march=armv7-a -Wl,--as-needed -Wl,-z,noexecstack -Wl,--warn-common -Wl,-rpath-link=libpostproc:libswresample:libswscale:libavfilter:libavdevice:libavformat:libavcodec:libavutil:libavresample
LDEXEFLAGS=
LDLIBFLAGS=
...
EXTRALIBS=-lssl -lcrypto  -lmxutil -lmxutil -lmxutil -lm -lz -pthread -L../libs/armeabi-v7a/vfpv3-d16 -L../libs/android/16-arm -lmxutil -lm 
...
libavfilter_VERSION=6.13.100
libavfilter_VERSION_MAJOR=6
libavfilter_VERSION_MINOR=13
libavformat_VERSION=57.11.100
